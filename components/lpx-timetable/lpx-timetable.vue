<template>
	...
	<!-- 			<view class="lxy" v-for="(item,index) in courseee">
					<view class="lxy2" v-for="(item2,index) in item"
						:style="{height:(item2.length * 80) + 'px',background:item2.background}">{{item2.length}}</view>
				</view> -->
			</view>
		</view>
	</view>
